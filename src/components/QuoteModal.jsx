...
import { X, CheckCircle2, FileText, Send, Phone, Sun, Shield } from 'lucide-react';
          ...
          <div className="text-center py-8 space-y-4">
            ...
            <div className="pt-4 flex flex-col sm:flex-row justify-center gap-3">
              <a
                ...
                className="bg-[#0D2F45] text-white text-xs font-bold py-2.5 px-5 rounded-lg inline-flex items-center justify-center space-x-2"
              >
              ...
              <button
                onClick={handleReset}
                className="bg-slate-200 text-slate-800 text-xs font-bold py-2.5 px-5 rounded-lg hover:bg-slate-300 transition-colors"
              >
                Close Window
              </button>
            </div>
