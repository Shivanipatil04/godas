                  ...
                  <div className="space-y-4 text-xs text-slate-600">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${companyInfo.emails.sales}`} className="hover:text-[#16A34A] block">
                          {companyInfo.emails.sales}
                        </a>
                        <a href={`mailto:${companyInfo.emails.info}`} className="hover:text-[#16A34A] block text-slate-500">
                  ...
                  {!submitted ? (
                    ...
                    <div className="text-center py-12 space-y-4">
                      ...
                      <button
                        ...
                        className="bg-slate-100 text-[#14532D] text-xs font-bold py-2.5 px-5 rounded-xl hover:bg-slate-200 border border-slate-200 cursor-pointer"
                      >
